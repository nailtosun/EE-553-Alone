function [x,it,fcall,T] = fibonacciSearch(f,xL,xU,tolerance,display)
...
fcall = 0;
n = round(abs(xU-xL)/tolerance); %Array Length
T = 0;
m = 0;  %Fibonacci Index
...
fL = feval(f,xL); fcall = fcall + 1;
fU = feval(f,xU);fcall = fcall + 1;
